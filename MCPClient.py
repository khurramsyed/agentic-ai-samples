...
class MCPClient:
    def __init__(
        self, model_provider: str = "anthropic", aws_region: str = "us-east-1"
    ):
...
async def main():
    server_configs = [
        {
            "name": "server1",
            "url": os.getenv("MCP_SERVER_1", "http://localhost:8050/sse"),
        },
        {
            "name": "server2",
            "url": os.getenv("MCP_SERVER_2", "http://localhost:8051/sse"),
        },
    ]
